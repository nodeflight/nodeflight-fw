...
// PP_INST_DECL(timer, tim13_ch1, TIMER_DEF(14, 1, TIM8_TRG_COM_TIM14_IRQn),
// );
// PP_INST_DECL(timer, tim13_ch2, TIMER_DEF(14, 2, TIM8_TRG_COM_TIM14_IRQn),
// );
// PP_INST_DECL(timer, tim13_ch3, TIMER_DEF(14, 3, TIM8_TRG_COM_TIM14_IRQn),
// );
// PP_INST_DECL(timer, tim13_ch4, TIMER_DEF(14, 4, TIM8_TRG_COM_TIM14_IRQn),
// );
